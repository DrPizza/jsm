{
	...
	'linker_command'  : {
		'win32:msvc:*:*:*'      : '${linker} /libpath:${lib-directories} ${linker-flags} ${libs} ${objects} /PDB:${output-dir}${target-name}.pdb /out:${output-dir}${target-name}.exe',
...
//		'static': '%{filename}.dll', // or 'lib%{filename}.a'
